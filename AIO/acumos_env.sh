...
export PORTAL_BE_IMAGE=cicd.ai4eu-dev.eu:7444/ai4eu/acumos-portal-be:4.0.14-ai4eu-v9
export PORTAL_FE_IMAGE=cicd.ai4eu-dev.eu:7444/ai4eu/acumos-portal-fe:4.0.14-ai4eu-v9
...
export DESIGNSTUDIO_IMAGE=cicd.ai4eu-dev.eu:7444/ai4eu/ds-compositionengine:3.0.7-ai4eu
export FEDERATION_IMAGE=$ACUMOS_RELEASE/acumos/federation-gateway:3.2.3
export KUBERNETES_CLIENT_IMAGE=cicd.ai4eu-dev.eu:7444/acumos/kubernetes-client:3.0.24
...
export BLUEPRINT_ORCHESTRATOR_IMAGE=cicd.ai4eu-dev.eu:7444/generic-serial-orchestrator/orchestrator_container:v3
